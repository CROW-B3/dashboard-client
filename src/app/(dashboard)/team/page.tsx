    ...
    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6 sm:mb-8">
      ...
      <div className="flex flex-col items-start sm:items-end gap-2">
        <div className="flex items-center gap-3">
          <button
            type="button"
            className="h-[38px] px-4 flex items-center justify-center rounded-lg text-sm font-medium transition-colors hover:bg-white/5"
            style={{
              color: '#D1D5DB',
          ...
          <button
            type="button"
            className="h-[38px] px-4 flex items-center justify-center rounded-lg text-sm font-medium text-white transition-colors"
            style={{
              background: '#7C3AED',
              boxShadow: '0px 0px 15px rgba(124, 58, 237, 0.30)',
